...
- Portfolio entries are compact cards within the Portfolio tab. The confirmed entries are `Ray Tracing Scene Lab`, `Airspace Replay`, and `my linear`; do not invent employers, dates, metrics, or additional projects.
